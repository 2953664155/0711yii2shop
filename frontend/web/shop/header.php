            ...
            <dd>
                <div class="prompt">
                    ...
                    if (Yii::$app->user->isGuest){
                        echo "您好，请<a href='http://www.yii2shop.com/member/login'>登录</a>";
                    }else{
                        echo "欢迎登录!!&emsp;<a href='http://www.yii2shop.com/member/logout'>注销</a>";
                    }
                ...
                <div class="uclist mt10">
                    <ul class="list1 fl">
                        <li><a href="">用户信息></a></li>
                        <li><a href="">我的订单></a></li>
                        <li><a href="http://www.yii2shop.com/address/address">收货地址></a></li>
                        <li><a href="">我的收藏></a></li>
                    </ul>
